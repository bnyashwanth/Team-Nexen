...
poi_actual_score = create_pipeline()
poi_actual_score.fit(X, y)

model_path = os.path.join(model_dir, "model_poi_actual_score.pkl")
with open(model_path, "wb") as f:
    pickle.dump(poi_actual_score, f)
